...
namespace VSP
{
    public static class MainWindowMonitor
    {
        public static event EventHandler DeviceChangedEvent;//定义在Monitor中的一个事件
        public static event EventHandler WindowClosedEvent;
...
/// <returns></returns>
        ...
        public static void DeviceChangedFunction()
        {
            DeviceChangedEvent?.Invoke(null, null);//触发事件，执行所有注册过的函数
        }
